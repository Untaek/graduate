...
const char* topic_sensor = const_cast<char*>(String("sensor-" + String(device_id)).c_str());
const char* topic_target = const_cast<char*>(String("target-" + String(device_id)).c_str());
...
void loop() {
  ...
  if(Serial.available()) {
    ...
    Serial.println(String("sensor-" + String(device_id)).c_str());
    Serial.println(buf);
    client.publish(String("sensor-" + String(device_id)).c_str(), buf);
    Serial.flush();
  }
}
